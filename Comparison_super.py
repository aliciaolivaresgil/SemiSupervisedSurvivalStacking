...
from utils.survival_stacking import stack_timepoints, stack_eval, cumulative_hazard_function, risk_score, filter_times_on_test, survival_function
...
def repeatedCrossVal(estimator, param_grid, X, y, n_splits, random_state): 
    ...
    for i, (train_index, test_index) in enumerate(outer_cv.split(X, time_bin)):
        ...
        X_fun_train, y_fun_train = stack_timepoints(X_train, y_train, event_times)
